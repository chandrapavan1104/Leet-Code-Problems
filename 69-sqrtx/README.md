...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: x = 8
Output: 2
Explanation: The square root of 8 is 2.82842..., and since the decimal part is truncated, 2 is returned." data-snippet-id="ext.7a647964aaea9d7f74a797b21154c7a5" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> x = 8
<strong>Output:</strong> 2
